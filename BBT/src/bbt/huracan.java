 ...
 * @author Satyendra
 */
public class huracan extends javax.swing.JFrame {
int i=310;
    /**
     * Creates new form huracan
     */
    public huracan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("LH589");
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 467, 96, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/317.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 740, 381));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, 0, 780, 620));
 ...
 jLabel1.setIcon(new ImageIcon("D:\\Project\\CARS BRANDS\\Lamborghini\\huracan\\"+i+".jpg"));
    i++;        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(huracan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
