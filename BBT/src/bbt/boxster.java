 ...
 * @author Satyendra
 */
public class boxster extends javax.swing.JFrame {
int i=220;
    /**
     * Creates new form boxster
     */
    public boxster() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("PB142");
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 467, 96, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/225.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, 0, 790, 630));
...
jLabel1.setIcon(new ImageIcon("D:\\Project\\CARS BRANDS\\Porsche\\boxters\\"+i+".jpg"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(boxster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
