 ...
 * @author Satyendra
 */
public class r8s extends javax.swing.JFrame {
int i=140;
    /**
     * Creates new form r8s
     */
    public r8s() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("S239R");
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 467, 96, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/142.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 757, 381));
...
jLabel1.setIcon(new ImageIcon("D:\\Project\\CARS BRANDS\\Audi\\r8sp\\"+i+".jpg"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(r8s.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
