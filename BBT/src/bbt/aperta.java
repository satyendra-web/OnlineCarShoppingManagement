 ...
 * @author Satyendra
 */
public class aperta extends javax.swing.JFrame {
    int i=230;

    /**
     * Creates new form aperta
     */
    public aperta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("New Ferrari Aperta 2k17");
        ...
        jTextField4.setText("$1.5 million");
        ...
        jTextField2.setText("CZ6");
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 467, 96, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/240.jpg"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/015.jpg"))); // NOI18N
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, 0, 780, 630));
...
jLabel1.setIcon(new ImageIcon("D:\\Project\\CARS BRANDS\\Ferrari\\aperta\\"+i+".jpg"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aperta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
