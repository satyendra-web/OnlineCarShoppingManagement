 ...
 * @author Satyendra
 */
public class centenario extends javax.swing.JFrame {
int i=290;
    /**
     * Creates new form centenario
     */
    public centenario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("The New Centenario 2k17");
        ...
        jTextField2.setText("LC784");
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 467, 96, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/298.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, -1, 381));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/019.png"))); // NOI18N
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
          jLabel1.setIcon(new ImageIcon("D:\\Project\\CARS BRANDS\\Lamborghini\\centenario\\"+i+".jpg"));
    i++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(centenario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new centenario().setVisible(true);
            }
        });
    }
