 ...
 * @author Satyendra
 */
public class gtb extends javax.swing.JFrame {
    int i=210;

    /**
     * Creates new form gtb
     */
    public gtb() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/213.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 750, 381));
        ...
        jTextField4.setText("$245,737");
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 505, 96, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bbt/020.jpg"))); // NOI18N
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
            jLabel1.setIcon(new ImageIcon("D:\\Project\\CARS BRANDS\\Ferrari\\488gtb\\"+i+".jpg"));
    i++;
 ...
 JOptionPane.showMessageDialog(null,e.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gtb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
